...
//function for changing seat status


void markseatvisited(char *foundseat,int selected_seat,char *seat_line)
{
    printf("\n");
...
int main()
{
    ...
    // printing seats with seatdesign function
    ...
    seatdesign(total_seats, found_seats[stmp]);
    ...
    markseatvisited(found_seats[stmp], my_seat, seat_line[stmp]);
